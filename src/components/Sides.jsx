...
export default function Sides() {
  ...
  return (
    <div>
    <button onClick={breakfastSideFoods} className="button-size">Breakfast Side</button><br />
    <button onClick={lunchSideFoods} className="button-size">Lunch Side</button><br />
    <button onClick={dinnerSideFoods} className="button-size">Dinner Side</button>
    </div>
  )
}